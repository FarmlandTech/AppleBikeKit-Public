...
#ifndef APPLEBIKEKITSOURCECODE_SWIFT_H
#define APPLEBIKEKITSOURCECODE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppleBikeKitSourceCode",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC22AppleBikeKitSourceCode20CoreBluetoothService")
@interface CoreBluetoothService : NSObject
...
@class NSString;
@class NSNumber;
@interface CoreBluetoothService (SWIFT_EXTENSION(AppleBikeKitSourceCode)) <CBCentralManagerDelegate>
...
@interface CoreBluetoothService (SWIFT_EXTENSION(AppleBikeKitSourceCode)) <CBPeripheralDelegate>
...
/// }
///
/// \endcode如果嘗試讀取不可讀的特徵，便會在此回調得到 error 。
/// 收到訂閱的值時，也會調用此回調。
...
SWIFT_CLASS("_TtC22AppleBikeKitSourceCode14CoreSDKService")
@interface CoreSDKService : NSObject
/// 建構子。
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
